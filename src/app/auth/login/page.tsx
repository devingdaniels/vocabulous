    ...
    <div className="flex min-h-screen flex-col items-center justify-center p-24 bg-gradient-to-b from-zinc-900 to-black">
      <div className="z-10 max-w-5xl w-full items-center justify-center font-mono text-sm flex flex-col gap-8">
        <h1 className="text-6xl font-bold text-white mb-8">
          Welcome to <span className="text-blue-500">Vocabulous</span>
        </h1>
        <p className="text-xl text-gray-300 mb-8 text-center max-w-2xl">
          Your personal vocabulary builder. Sign in to start expanding your vocabulary and track your progress.
        </p>
        <Button 
